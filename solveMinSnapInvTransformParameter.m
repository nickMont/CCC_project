function [SolCoeff,Cost,logCond] = solveMinSnapInvTransformParameter(Waypoints,threshold)

n_w = numel(Waypoints.t);
n = 7;  %This solution only uses 7th order polynomials
% tic;
%Quadratic matrix
...
Tinv = transformationMatrixThreshold(n,Waypoints.t,n_w,threshold);
